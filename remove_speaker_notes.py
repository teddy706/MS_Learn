...
# Flatten slides with part info (Notes removed)
all_slides = []
    ...
    <header class="no-print h-14 bg-white/80 backdrop-blur-md border-b border-indigo-100 text-slate-800 flex items-center justify-between px-4 z-40 shrink-0 select-none shadow-xs">
        ...
        <div class="flex items-center space-x-2">
            ...
            <div class="relative hidden md:block">
                <input type="text" id="searchInput" placeholder="슬라이드 / 키워드 검색..." class="bg-white/90 border border-slate-200 rounded-xl px-3 py-1 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:border-indigo-400 w-48 shadow-2xs">
            </div>
...
print(f"Successfully cleaned up speaker notes and regenerated portal at {output_path}")
