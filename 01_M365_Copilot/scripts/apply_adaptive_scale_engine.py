...
<head>
    ...
    <style>
        ...
        * {{
        ...
        /* Microsoft 365 Official Radial Background */
        body {{
        ...
        .ms-16-9-canvas {{
            width: 1200px;
            height: 675px; /* Perfect 16:9 Aspect Ratio */
            max-width: 100%;
            background: #ffffff;
...
<body class="h-full flex flex-col antialiased">
    ...
    <header class="no-print h-14 bg-white/90 backdrop-blur-md border-b border-slate-200 text-slate-800 flex items-center justify-between px-4 z-40 shrink-0 shadow-xs">
        <div class="flex items-center space-x-3">
            ...
            <div class="flex items-center space-x-2.5">
                ...
                <span class="text-xs text-slate-500 font-bold hidden sm:inline uppercase tracking-wider">통신·네트워크 실무 마스터 (반응형 16:9)</span>
            </div>
        </div>
    ...
    <script>
        ...
        function autoScaleSlide() {{
            ...
            const availWidth = wrapper.clientWidth - 32;  // Margin padding
            ...
            // Cap scale between 0.45 and 1.1 for optimal readability
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write(adaptive_html)

# Also create an index.html copy for direct GitHub Pages / web server deployment
index_path = "/Users/gwanghee/Documents/110_Github/MS_Learn/index.html"
with open(index_path, "w", encoding="utf-8") as f:
    f.write(adaptive_html)

print(f"Successfully generated adaptive 16:9 auto-scaling web presentation at {output_path} and {index_path}")
