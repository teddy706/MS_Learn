...
<body class="h-full flex flex-col antialiased">
    ...
    <script>
        ...
        function renderSlide(index) {{
            ...
            // Render Center Card in 16:9 Slide Mode (Copy prompt button removed)
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write(clean_ui_html)

with open(index_path, "w", encoding="utf-8") as f:
    f.write(clean_ui_html)

print(f"Successfully removed copy prompt buttons from {output_path} and {index_path}")
