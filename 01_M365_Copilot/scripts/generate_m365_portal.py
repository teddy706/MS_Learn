...
# Complete 33 Units with App Theme Metadata
modules = [
    {
        "id": "part-1",
        "part_num": "Part 1",
        "title": "Copilot 기초 & 보안 아키텍처",
        "app": "copilot",
        "app_name": "M365 Copilot Core",
        "app_icon": "✨",
        "badge_color": "bg-gradient-to-r from-violet-600 to-indigo-600 text-white",
        "theme": {
            "primary": "#6366f1",
            "accent": "#8b5cf6",
            "bg_light": "#f5f3ff",
            "border": "#ddd6fe",
            "header_gradient": "from-slate-950 via-indigo-950 to-slate-900",
            "nav_active": "border-indigo-500 text-indigo-600 bg-indigo-50"
        },
        "slides": [
            {
                "num": "01",
                ...
                "subtitle": "파편화된 인프라 데이터 맥락을 스스로 잇는 Work IQ 인텔리전스 계층의 도입",
                "body": """
                ...
                """,
                "notes": "오프닝 인사: 단순 오피스 작업 도구가 아닌 통신/네트워크 인프라 엔지니어링 실무를 혁신하는 2026 에이전틱 AI 아키텍처 과정을 시작합니다."
            },
            {
                "num": "02",
                "badge": "MODEL ARCHITECTURE",
                "title": "3대 차세대 AI 모델 전략적 선택 기준 (Model Toggling)",
            ...
            },
            {
                "num": "03",
                "badge": "CLOUD SYNERGY",
                "title": "엔지니어를 위한 5대 클라우드 시너지 & Copilot Cowork",
            ...
            },
            {
                "num": "04",
                "badge": "GRAPH & EDP",
                "title": "M365 Copilot 기술 아키텍처 & 엔터프라이즈 데이터 보호(EDP)",
            ...
            },
            {
                ...
                "title": "[MS Learn 공식] 통신 엔지니어링 프롬프트 4대 요소 (GCS-E)",
            ...
            },
            {
                ...
                "title": "[보안 딥다이브] Work vs Web 모드 & 쿼리 변환(Query Transformation)",
    ...
    # Part 2. Excel (Microsoft Excel Signature Green Theme)
    {
        "id": "part-2",
        "part_num": "Part 2",
        "title": "Excel 트래픽 인텔리전스 & 분석가 도구",
        "app": "excel",
        ...
        "theme": {
            ...
            "bg_light": "#f0fdf4",
            "border": "#bbf7d0",
            "header_gradient": "from-slate-950 via-emerald-950 to-slate-900",
            "nav_active": "border-emerald-600 text-emerald-700 bg-emerald-50"
        },
        "slides": [
            {
                "num": "07",
                "badge": "TRIMMING REFERENCES",
                "title": "[2026 신기능] 대규모 에러 로그 정제 & 트리밍 참조 (.:.)",
            ...
            },
            {
                "num": "08",
                "badge": "AUTO REFRESH",
                "title": "트래픽 피벗 집계 및 피벗 자동 새로고침(Pivot Auto Refresh)",
            ...
            },
            {
                "num": "09",
                "badge": "ANALYST AGENT",
                "title": "[핵심] 분석가 도구(Analyst Agent)와 Python in Excel 메커니즘",
            ...
            },
            {
                ...
                "title": "통신망 이상 트래픽(DDoS/스파이크) 탐지 & 히트맵 시각화",
            ...
            },
            {
                ...
                "title": "5G/인프라 대역폭 사이징 및 시계열 예측(Forecasting)",
            ...
            },
            {
                ...
                "title": "🧪 [실습 1] 5만 건 방화벽 로그 이상치 분석 & 대시보드 구축",
    ...
    # Part 3. Diagrams as Code (Excalidraw / Mermaid Vector Theme - Cyan/Teal)
    {
        "id": "part-3",
        "part_num": "Part 3",
        "title": "다이어그램 코드화 (Mermaid & Excalidraw)",
        "app": "diagrams",
        "app_name": "Diagrams as Code",
        "app_icon": "📐",
        ...
        "theme": {
            ...
            "bg_light": "#f0fdfa",
            "border": "#99f6e4",
            "header_gradient": "from-slate-950 via-teal-950 to-slate-900",
            "nav_active": "border-teal-600 text-teal-700 bg-teal-50"
        },
        "slides": [
            {
                "num": "13",
                "badge": "DIAGRAMS AS CODE",
                "title": "Diagrams as Code: 텍스트 기반 다이어그램 생성 원리",
            ...
            },
            {
                ...
                "title": "Copilot을 활용한 Mermaid 통신 토폴로지 코드 생성",
            ...
            },
            {
                ...
                "title": "Excalidraw 원클릭 연동 (Mermaid to Diagram)",
    ...
    # Part 4. Outlook (Microsoft Outlook Signature Blue Theme)
    {
        "id": "part-4",
        "part_num": "Part 4",
        "title": "Outlook 스마트 이메일 & 캘린더 위임",
        "app": "outlook",
        ...
        "theme": {
            ...
            "bg_light": "#eff6ff",
            "border": "#bfdbfe",
            "header_gradient": "from-slate-950 via-blue-950 to-slate-900",
            "nav_active": "border-blue-600 text-blue-700 bg-blue-50"
        },
        "slides": [
            {
                "num": "17",
                "badge": "ATTACHMENT LISTING",
                "title": "NOC Level-1 인시던트 요약 & 첨부파일 목록화 (Attachment Listing)",
            ...
            },
            {
                "num": "18",
                "badge": "CROSS-CONTEXT",
                "title": "[2026 신기능] 포괄적 크로스 컨텍스트 추론 (Cross-Context Reasoning)",
            ...
            },
            {
                ...
                "title": "[@Calendar Agent] 현장 엔지니어 리소스 재배치 & 위임 관리",
            ...
            },
            {
                ...
                "title": "🧪 [실습 3] 글로벌 TAC 메일 분석 ➔ 고객사 회신 ➔ 캘린더 위임 예약",
    ...
    # Part 5. PowerPoint (Microsoft PowerPoint Signature Coral/Orange Theme)
    {
        "id": "part-5",
        "part_num": "Part 5",
        "title": "PowerPoint 데이터 그라운딩 & 제안서 현대화",
        "app": "powerpoint",
        ...
        "theme": {
            ...
            "bg_light": "#fff7ed",
            "border": "#fed7aa",
            "header_gradient": "from-slate-950 via-orange-950 to-slate-900",
            "nav_active": "border-orange-600 text-orange-700 bg-orange-50"
        },
        "slides": [
            {
                "num": "21",
                "badge": "POWER BI GROUNDING",
                "title": "[2026 핵심] Power BI Grounding 기반 네트워크 품질 제안서 생성",
            ...
            },
            {
                ...
                "title": "브랜드 키트 일괄 적용 (Brand Kit & Style Restyle)",
            ...
            },
            {
                ...
                "title": "댓글 내 작업 할당 & 발표자 노트 (Speaker Notes)",
            ...
            },
            {
                ...
                "title": "🧪 [실습 4] Power BI 품질 지표 그라운딩 ➔ 3단 제안서 빌드",
    ...
    # Part 6. Word & OneNote (Microsoft Word Royal Blue / OneNote Purple Theme)
    {
        "id": "part-6",
        "part_num": "Part 6",
        "title": "Word & OneNote 고정밀 기술문서화 & 현장 지식화",
        "app": "word",
        "app_name": "Microsoft Word & OneNote",
        "app_icon": "📝",
        ...
        "theme": {
            ...
            "bg_light": "#f0f9ff",
            "border": "#bae6fd",
            "header_gradient": "from-slate-950 via-sky-950 to-slate-900",
            "nav_active": "border-sky-600 text-sky-700 bg-sky-50"
        },
        "slides": [
            {
                "num": "25",
                "badge": "TRACK CHANGES",
                "title": "[2026 핵심] 기술 규격 대조, Track Changes & 진행 메시지(Progress Messages)",
            ...
            },
            {
                ...
                "title": "리스크 플래그, 참조 출처(Citations) & Review Summary 섹션",
            ...
            },
            {
                ...
                "title": "난해한 기술 규격(RFC, 벤더 스펙)의 쉬운 해설화",
            ...
            },
            {
                ...
                "title": "OneNote AI 전자필기장 & 모바일 Word 현장 음성 보고",
            ...
            },
            {
                ...
                "title": "🧪 [실습 5] 5G Core 장애 RCA 보고서 작성 (Review Summary & Progress)",
    ...
    # Part 7. Teams, Copilot Cowork & Governance (Microsoft Teams Purple & Enterprise Slate)
    {
        "id": "part-7",
        "part_num": "Part 7",
        "title": "Teams 회의 협업 & Copilot Cowork 종합 실습",
        "app": "teams",
        "app_name": "Teams & Cowork",
        "app_icon": "🏆",
        ...
        "theme": {
            ...
            "border": "#c7d2fe",
            "header_gradient": "from-slate-950 via-indigo-950 to-slate-900",
            "nav_active": "border-indigo-700 text-indigo-800 bg-indigo-50"
        },
        "slides": [
            {
                "num": "30",
                "badge": "TEAMS RECAPS",
                "title": "[2026 신기능] Teams 비디오/오디오 리캡 & Meeting Recaps App",
            ...
            },
            {
                "num": "31",
                "badge": "CAPSTONE LAB",
                "title": "🏆 [종합 실습] Copilot Cowork 기반 5G Core 대규모 장애 E2E 파이프라인",
            ...
            },
            {
                ...
                "title": "Agent 365 ROI 모니터링 & Microsoft Purview 보안 거버넌스",
            ...
            },
            {
                "num": "33",
                "badge": "FINAL WRAP-UP",
                "title": "[실무 즉시 적용] 통신 전용 프롬프트 치트시트 & Architect's Note",
...
print("Modules prepared successfully.")
