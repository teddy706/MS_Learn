...
font_portal_html = f"""<!DOCTYPE html>
...
<head>
    ...
    <!-- Google Fonts & CDN Fonts for High Readability -->
    ...
    <header class="no-print h-14 bg-white/95 backdrop-blur-md border-b border-slate-200 text-slate-800 flex items-center justify-between px-4 z-40 shrink-0 shadow-xs">
        ...
        <div class="flex items-center space-x-2.5">
            ...
            <div class="relative hidden md:block">
                <input type="text" id="searchInput" placeholder="프롬프트 / 시나리오 검색..." class="bg-slate-100/90 border border-slate-200 rounded-full px-3.5 py-1 text-xs md:text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:bg-white w-44 transition-all">
            </div>
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write(font_portal_html)

with open(index_path, "w", encoding="utf-8") as f:
    f.write(font_portal_html)

print(f"Successfully added high-legibility fonts and dynamic font switcher at {output_path} and {index_path}")
